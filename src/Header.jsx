...
export default function Header() {
  return (
    <>  
    <div className="container-fluid nav_bg Nav_Header">
        <div className="row">
            <div className="col-lg-11 mx-auto">
                <nav className="navbar navbar-expand-lg">
                <div className="container-fluid">
                    <a className="navbar-brand" href="#"> <img src="https://preview.colorlib.com/theme/sierra/img/logo.png" alt="Logo" /></a>
                    ...
                    <ul className="navbar-nav ms-auto mb-2 mb-lg-0 text-center">
                        ...
                        <ul className="dropdown-menu">
                            ...
                            <li><NavLink className="dropdown-item" to="/blogdetail">Blog Details</NavLink></li>
                            <li><hr className="dropdown-divider" /></li>
                            <li><NavLink className="dropdown-item" to="/blogdetail">Elements</NavLink></li>
                        </ul>
                        </li>
                        <li className="nav-item">
